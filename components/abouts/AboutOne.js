            ...
            <div className="axil-about-inner">
              <div className="section-title text-start">
                ...
                <h2
                  ...
                  data-aos-delay="200"
                >
                  Мы делаем дизайн, верстку <br /> и разработку.
                </h2>
                <p
                  ...
                  data-aos-delay="400"
                >
                  Внимательно относимся к Вашим пожеланиям, стараемся подобрать оптимальные решения к выполненинию вашей задачи.
				  У нас много наработанных решений и мы вместе подбираем вам оптимальный хостинг и Систему редактирования контента.
                </p>
                <p
                  ...
                  data-aos-delay="500"
                >
                  На предварительном этапе мы не берем денег за разговоры и подбор похожих решений, осбуждение блоков и составление Технического задания.
                </p>
              </div>
            </div>
          </div>
