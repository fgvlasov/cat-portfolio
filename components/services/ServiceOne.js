            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12">
                        <SectionTitle
                            title="Полезные для Вас услуги"
                            subtitle="что мы вам готовы предложить"
                            description="на самом деле любые услуги, хотите погладим, хотите мисочку найдем классную, а может пару вам найдем..."
                            color="extra08-color"
                            alignment="center"
                        />
                    </div>
